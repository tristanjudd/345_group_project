...
int ordersDriver() {
	...
	p1->setTerritories(&territories1);
	p2->setTerritories(&territories2);
	...
	*/
	...
	cout << endl;
	Deploy* d1 = new Deploy(p1, 10, t1); //Player 1 deploys 10 troops to territory 1
	d1->execute();
	cout << *d1 <<  endl;
	cout << *t1->getArmyCount() << endl;

	cout << endl;
	Advance* a1 = new Advance(p1, 3, t1, t3); //Player 1 advances 3 troops from territory 1 to territory 3
	a1->execute();
	cout << *a1 << endl;
	cout << *t1->getArmyCount() << endl;
	...
	cout << endl;
	Bomb* b1 = new Bomb(p1, t4); //Player 1 bombs territory 2
	b1->execute();
	cout << *b1 << endl;
	cout << *t4->getArmyCount() << endl;
	
	cout << endl;
	Airlift* al1 = new Airlift(p1, 3, t5, t3); //Player 1 airlifts 3 troops from territory 5 to territory 3
	al1->execute();
	cout << *al1 << endl;
	...
	cout << endl;
	Blockade* bl1 = new Blockade(p1, t3); //Player 1 blockades territory 3
	bl1->execute();
	cout << *bl1 << endl;
	cout << *t3->getArmyCount() << endl;
	...
	cout << endl;
	Advance* attack = new Advance(p1, 12, t1, t2); //Player 1 advances 12 troops from territory 1 to territory 2
	attack->execute();
	cout << *attack << endl;
	cout << *t1->getArmyCount() << endl;
	...
	cout << endl;
	Negotiate* n1 = new Negotiate(p1, 2); //Player 1 negotiates with Player 2;
	n1->execute();
	cout << *n1 << endl;
	...
	cout << endl;
	Deploy* d2 = new Deploy(p2, 10, t1); //Player 2 deploys 10 troops to territory 1 (invalid)
	d2->execute();
	cout << *d2 << endl;

	cout << endl;
	Advance* a2 = new Advance(p2, 3, t6, t5); //Player 2 advances 3 troops from territory 6 to territory 5 (invalid)
	a2->execute();
	cout << *a2 << endl;

	cout << endl;
	Bomb* b2 = new Bomb(p2, t1); //Player 2 bombs territory 1 (invalid)
	b2->execute();
	cout << *b2 << endl;

	cout << endl;
	Negotiate* n2 = new Negotiate(p2, 2); //Player 2 negotiates with Player 2 (invalid)
	n2->execute();
	cout << *n2 << endl;
